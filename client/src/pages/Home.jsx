...
export default function Home() {
    return (
      <div>
        <Container>
        <NavLink to="/AddDog" style={{ textDecoration: 'none' }}><Para> Add Doggo</Para></NavLink>
        <NavLink to="/ShelterRegister" style={{ textDecoration: 'none' }}><Para>Register as shelter / Login</Para></NavLink>
        </Container>
